      ...
      <div className="h-full flex justify-center items-center p-4">
        <div className="container grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="text-white space-y-4 lg:pr-36">
            ...
            <button data-aos="fade-up" data-aos-delay="500" className="bg-blue-400 text-white hover:bg-blue-500 px-4 py-1 rounded-md duration-200" onClick={() => window.scrollTo({ top: document.getElementById('rapidscat').offsetTop, behavior: 'smooth' })}>
            LEARN MORE
          </button>
